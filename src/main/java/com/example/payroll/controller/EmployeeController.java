...
import com.example.payroll.hateoas.EmployeeModelResourceAssembler;
...
public class EmployeeController {
    ...
    private final EmployeeModelResourceAssembler assembler;

    EmployeeController(EmployeeRepository repository, EmployeeModelResourceAssembler assembler) {
